...
<Columns cols={2}>
  <Card title="Write with MDX" icon="pen-fancy" href="/essentials/markdown" cta="test">
  ...
  <Card title="Test Card" icon="amp-guitar" iconType="duotone" cta="Test CTA">
...
<Update label="08/07/2025" description="">
  tets updat
</Update>
